...
ctrl["debt"] = ctrl["totalliabilities"] / (ctrl["totalassets"] + 1)  # 资产负债率
...
ctrl_cols = ["stkcode", "year", "lnage", "lnsize", "klr", "lev",
             "bsize", "dual", "lnrd", "indrate", "own", "debt",
...
output_vars = [
    ...
    "Dea_count", "Breadth_count", "Depth_count",
    "lnage", "lnsize", "klr", "lev", "bsize", "dual", "indrate", "own", "lnrd", "debt",
    "IC", "cost",
